...
export declare const AppProgressBar: React.MemoExoticComponent<({ options, shallowRouting, disableSameURL, startPosition, delay, stopDelay, targetPreprocessor, disableAnchorClick, }: ProgressBarProps) => null>;
